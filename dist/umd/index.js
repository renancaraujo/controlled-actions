(function (global, factory) {
  ...
  (factory((global.controlledtActions = {})));
  ...
  //      
  var Action = function Action(actionFunction) {
    var _this = this;

    classCallCheck(this, Action);

    this._createRoutine = function (payload) {
      var returnedPromise = _this.actionFunction(payload);
      return Promise.resolve(returnedPromise);
    };

    this.execute = function (payload) {
      return _this._createRoutine(payload);
    };
  ...
  var ActionFirst = function (_Action) {
    ...
    function ActionFirst(actionFunction) {
      ...
      _this._reset = function () {
        _this.executingPayload = null;
        delete _this.promise;
      };

      _this.execute = function (payload) {
        if (_this.promise && isEqual_1(payload, _this.executingPayload)) {
          return _this.promise;
        }
        var promise = _this._createRoutine(payload);
        _this.promise = promise;
        _this.executingPayload = payload;
        promise.finally(_this._reset);
        return promise;
      };
  ...
  var ActionForceFirst = function (_ActionFirst) {
    ...
    function ActionForceFirst() {
      ...
      return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = ActionForceFirst.__proto__ || Object.getPrototypeOf(ActionForceFirst)).call.apply(_ref, [this].concat(args))), _this), _this.execute = function (payload) {
        if (_this.promise) {
          return _this.promise;
        }
        var promise = _this._createRoutine(payload);
  ...
  var ActionLast = function (_Action) {
    ...
    function ActionLast(actionFunction) {
      ...
      _this.execute = function (payload) {
        var newLastPromise = _this._createRoutine(payload);
        _this.lastPromise = newLastPromise;
        newLastPromise.then(function (result) {
          if (_this.lastPromise === newLastPromise) {
            _this._executeListeners(result);
          }
        }).catch(function (e) {
          if (_this.lastPromise === newLastPromise) {
            _this._executeRejectListeners(e);
          }
        }).finally(function () {
          if (_this.lastPromise === newLastPromise) {
        ...
        return new Promise(function (resolve, reject) {
          try {
            ...
            _this.resolveListeners = [].concat(toConsumableArray(_this.resolveListeners), [newResolveListener]);
            var newRejectListener = function newRejectListener(a) {
              return reject(a);
            };
            _this.rejectListeners = [].concat(toConsumableArray(_this.rejectListeners), [newRejectListener]);
          } catch (e) {
            reject(e);
          }
        });
